<div class="row">
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-aqua">
      ...
      <a href="<?php echo base_url('apps/User') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-green">
      <div class="inner">
        <h3><?php echo $jml_ruang; ?></h3>
      ...
      <a href="<?php echo base_url('apps/Ruang') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-yellow">
      <div class="inner">
        <h3><?php echo $jml_data; ?></h3>

        <p>Jumlah Notulensi</p>
      </div>
      <div class="icon">
        <i class="ion ion-ios-copy-outline"></i>
      </div>
      <a href="<?php echo base_url('apps/Notulen') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
